...
https://github.com/ito4303/SappoRoR9 で公開
...
```{r theme_excel, dev="cairo_pdf", fig.width=4.5, fig.height=3, out.height="6cm", cache=TRUE}
library(ggthemes)
p2 + theme_excel()
```
...
```{r geom_sf, dev="cairo_pdf", fig.width=4.5, fig.height=3, out.height="3.6cm", message=FALSE}
ggplot(hokkaido) + geom_sf(aes(fill = city)) +
...
```{r geom_sf2, dev="cairo_pdf", fig.width=4.5, fig.height=3, out.height="3.6cm", message=FALSE}
